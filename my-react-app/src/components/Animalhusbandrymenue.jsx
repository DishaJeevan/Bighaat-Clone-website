  ...
  const getProducts = async () => {
    try {
      ...
      const filtered = res.data.filter(
        (p) => p.subCategory  === "animalhusbandry"
      );
      ...
      <div className="main-container">
        <div className="sidebar">
          ...
          <details>
            ...
            <div className="content">
              <label>
                <input type="checkbox" /> Aqunata
              </label>
              <label>
                <input type="checkbox" /> AgroHaat
              </label>
              <label>
                <input type="checkbox" /> Pioneer Agro
              </label>
              <label>
                <input type="checkbox" /> Solar
              </label>
              <label>
                <input type="checkbox" /> Sarpan Hybrid Seeds Co
              </label>
            </div>
          </details>
          <details>
          ...
          <div className="products-grid-menu">
            {products.map((product) => (
              ...
              <div className="product-card-menu" key={product.id}>
                <div className="discount-menu">{product.discount}% OFF</div>
                <a href="#">
...
export default Animalhusbandrymenue;
